...
from copaw_worker.user_paths import build_session_file_path
...
class SafeJSONSession(SessionBase):
    ...
    def _get_save_path(self, session_id: str, user_id: str) -> str:
        ...
        """
        save_root = os.path.dirname(self.save_dir.rstrip(os.sep)) or self.save_dir
        return str(
            build_session_file_path(
                workspace_root=save_root,
